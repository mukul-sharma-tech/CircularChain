...
contract Market {
    ...
    event OrderCreated(uint256 orderId, uint256 listingId, uint256 quantity, uint256 totalAmount, address buyer);
    ...
    function createOrder(
        ...
        require(_quantityToBuy > 0, "Must buy at least one item.");
        ...
        emit OrderCreated(nextOrderId, _listingId, _quantityToBuy, totalAmount, msg.sender);
        nextOrderId++;
    }
